...
Narra currently supports one CSV per project, with a default upload limit of 4 MiB,
up to 100,000 data rows, and up to 200 columns. Uploaded datasets are immutable;
create another project to analyze a different file.
